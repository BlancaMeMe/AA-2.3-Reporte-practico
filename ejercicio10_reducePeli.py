...
filtro_nolan = list(filter(lambda pelicula: {"titulo": pelicula["Titulo"], "director": pelicula["Director"]} == "Christopher Nolan", lista_peliculas))
promedio_Nolan = sum([float(pelicula["CalificaciónIMDB"]) for pelicula in filtro_nolan])/len(filtro_nolan) if filtro_nolan else 0
