...
filtro_calificacion = list(filter(lambda pelicula: float(pelicula["CalificaciónIMDB"])>8, lista_peliculas))
altas_calificaciones = list(map(lambda pelicula: {"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]}, filtro_calificacion))
import json
print(json.dumps(altas_calificaciones, indent=2))