...
calificacionFor = [{"titulo": pelicula["Titulo"], 
            "calificacion": pelicula["CalificaciónIMDB"]} for pelicula in lista_peliculas]

calificacionMap = list(map(lambda pelicula: {"titulo": pelicula["Titulo"], 
            "calificacion": pelicula["CalificaciónIMDB"]},lista_peliculas))
import json
print(json.dumps(calificacionMap, indent=2))
print(json.dumps(calificacionFor, indent=2))